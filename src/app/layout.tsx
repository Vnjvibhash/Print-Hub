...
export const metadata: Metadata = {
  title: "SUVIR Printing - Professional Printing & Custom Merchandise",
      ...
      <body className="min-h-full flex flex-col bg-[#fafafc] dark:bg-[#07070a] text-[#0f0f15] dark:text-[#f3f4f6]">
        <AuthProvider>
          <div className="relative min-h-screen flex flex-col overflow-hidden">
            ...
            <a
              href="https://wa.me/917762974716?text=Hello%20SUVIR%20Printing%20Team%2C%20I%20need%20help%20with%20my%20order."
              target="_blank"
