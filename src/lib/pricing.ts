...
export function calculatePricing(
  ...
  // A. Standard Printing and Document Services (Charged per page)
  if ([
    "a4-bw", 
    "a4-color", 
    "a3-bw", 
    ...
    // Add Binding / Lamination option modifiers
  ...
  // B. Standalone Finishing / Binding Services (Charged flat per copy)
  else if (["spiral-binding", "lamination"].includes(serviceId)) {
    const copies = specs.copies || 1;
    subtotal = basePrice * copies * qty;
  }
  // C. Custom Merchandise
  else if ([
    "mug-print", 
    "magic-mug", 
    "tshirt-print", 
  ...
  // D. General flat services (e.g., Resume, passport photo sets, business services)
  else {
